    ...
    return (
        <View style={{backgroundColor: DARK_COLOR, flex: 1}}>
            <SafeAreaView style={{padding: 20, paddingBottom: 0, flexDirection: 'row'}}>
                ...
                <Text style={{fontSize: 60, color: GREEN_COLOR, fontWeight: 'bold'}}>Notification</Text>
            </SafeAreaView>
            <View style={{
            ...
            <SafeAreaView style={{alignSelf: 'flex-start', width: '100%'}}>
                <Text style={{color: GREEN_COLOR, textAlign: 'center', padding: 10, fontSize: 16}}>In order to keep
                    you updated
                    we need notifications permissions</Text>
                <Ripple rippleColor={'#fff'} onPress={onPress} style={{
                    ...
                    overflow: 'hidden',
                    alignSelf: 'center',
                }}><Ionicons name={'location'} color={DARK_COLOR} size={20}/>
                    <Text style={{color: DARK_COLOR, marginLeft: 10}}>Allow notifications permissions</Text>
                </Ripple>
                <Ripple onPress={() => {
                    setShowModal(true);
                }}>
                    <Text style={{color: GREEN_COLOR, textAlign: 'center', padding: 10, marginTop: 20, fontSize: 12}}>How
                        is my permission used?</Text>
                </Ripple>
            </SafeAreaView>
            <Modal isVisible={showModal}
                ...
                <View contentContainerStyle={{alignItems: 'center'}} style={{
                    backgroundColor: '#fff',
                    ...
                    <View style={{backgroundColor: GREEN_COLOR}}>
                        <Ripple rippleColor={DARK_COLOR} onPress={() => setShowModal(false)} style={{
                            alignItems: 'center',
                            padding: 15,
                            flexDirection: 'row',
                            ...
                            <Text style={{fontWeight: '700', color: DARK_COLOR, marginLeft: 5}}>Go back</Text>
                        </Ripple>
                    </View>
                    <ScrollView style={{
                        padding: 20,
                    }} contentContainerStyle={{alignItems: 'center'}}>
                        <SafeAreaView style={{paddingBottom: 50}} onStartShouldSetResponder={() => true}>
                            <Text>The standard Lorem Ipsum passage, used since the 1500s
                                ...
                                pleasures,
                                or else he endures pains to avoid worse pains."</Text>
                        </SafeAreaView>
                    </ScrollView>
                </View>
            </Modal>
