            ...
            <View style={{
                ...
                <SafeAreaView style={{alignSelf: 'flex-end', width: '100%'}}>
                    ...
                    <Ripple onPress={() => {
                        ...
                        <Text
                            style={{color: DARK_COLOR, textAlign: 'center', padding: 10, marginTop: 20, fontSize: 12}}>How
                    ...
                    <Modal isVisible={showModal}
                        ...
                        <View contentContainerStyle={{alignItems: 'center'}} style={{
                            ...
                            <View style={{backgroundColor: GREEN_COLOR}}>
                                <Ripple rippleColor={DARK_COLOR} onPress={()=>setShowModal(false)} style={{alignItems: 'center', padding: 15, flexDirection: 'row', alignSelf: 'flex-start'}}>
